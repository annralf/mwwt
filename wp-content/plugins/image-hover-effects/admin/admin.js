        ...
        var allcats = []; 
          jQuery('.accordian>.content').each(function(index,val) {
            ...
            jQuery(this).find('.ui-accordion-content').each(function(index, val) {
                ...
                images.scroll_animation = jQuery(this).find('.scroll-animation').val();
                images.cap_lightbox = jQuery(this).find('.caplightbox').val();
                images.cap_lightbox_content = jQuery(this).find('.caplightbox-content').val();
